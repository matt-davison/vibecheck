...
def GetFinance(searchTerm):
    api = NewsApiClient(api_key='64c70df4109b49529da4fa0dbbf949e1')

    all_headlines = ''

    for pageNum in range(1,6):
        all_articles = api.get_everything(q=searchTerm, page=pageNum, domains='cnbc.com, bloomberg.com, forbes.com').get('articles')
